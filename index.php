	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item cta"><a style="background-color:red; color: white;" data-toggle="modal" data-target="#exampleModal" href="#" class="nav-link">Register Now</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
                    ...
                    <center>
                        <div class="text p-4 pr-5 bg-danger">
                            <p class="mb-0">
                              ...
                              <a style="color:white;" data-toggle="modal" data-target="#exampleModal" href="#" class="nav-link">Register Now</a>
                          </p>
                        </div>
                    </center>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Event Has started, Register to Watch live</h5>
	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		...
		<div class="modal-body">
            ...
            <a href="login.php" class="btn btn-danger btn-lg"> Watch Live </a>
	  </div>
	</div>
  </div>
  			   ...
  			   $('#reg').html(oldbtn);
  				if (data == 'yes') {
  					alert('Registration was successful, kindly check your mail.')
  						window.location.href="http://gfmcph.com/gfmc_home.php";
  				}
  			}
  		})
  	})
