...
class __TwigTemplate_a6540291d1b69e965e8da9755b3cdf9d7e5d87dce55962033562a34ef303c03e extends \MailPoetVendor\Twig\Template
{
...
";
    ...
    {
        // line 30
        echo $this->env->getExtension('MailPoet\Twig\I18n')->localize(["noMailChimpLists" => $this->env->getExtension('MailPoet\Twig\I18n')->translate("No active lists found"), "serverError" => $this->env->getExtension('MailPoet\Twig\I18n')->translate("Server error:"), "select" => $this->env->getExtension('MailPoet\Twig\I18n')->translate("Select", "Form input type"), "wrongFileFormat" => $this->env->getExtension('MailPoet\Twig\I18n')->translate("Only comma-separated (CSV) file formats are supported."), "maxPostSizeNotice" => \MailPoetVendor\twig_replace_filter($this->env->getExtension('MailPoet\Twig\I18n')->translate("Your CSV is over %s and is too big to process. Please split the file into two or more sections."), ["%s" =>         // line 35
...
";
    ...
    {
        return array (  110 => 125,  108 => 35,  107 => 30,  104 => 29,  96 => 24,  94 => 23,  90 => 22,  86 => 21,  82 => 20,  77 => 18,  73 => 17,  69 => 16,  62 => 11,  60 => 10,  54 => 7,  50 => 6,  46 => 4,  43 => 3,  38 => 2,  36 => 1,  30 => 2,);
    }
